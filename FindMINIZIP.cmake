...
#    string(REGEX REPLACE "^.*MZ_VERSION +\\(\"([0-9]+).*$" "\\1" MIZIZIP_VERSION_MAJOR "${DEFINE_MZ_VERSION}")
#    string(REGEX REPLACE "^.*MZ_VERSION +\"[0-9]+\\.([0-9]+).*$" "\\1" MINIZIP_VERSION_MINOR "${DEFINE_MZ_VERSION}")
#    string(REGEX REPLACE "^.*MZ_VERSION +\"[0-9]+\\.[0-9]+\\.([0-9]+).*$" "\\1" MINIZIP_VERSION_PATCH "${DEFINE_MZ_VERSION}")
